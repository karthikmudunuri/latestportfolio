...
export const HeroHighlight = ({
  ...
  return (
    <div
      className={cn(
        "relative h-[47rem] flex items-center bg-black justify-center w-full group",
        containerClassName
      )}
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block pb-1   px-1 rounded-lg bg-gradient-to-r from-indigo-500 to-violet-500`,
        className
      )}
    >
      {children}
